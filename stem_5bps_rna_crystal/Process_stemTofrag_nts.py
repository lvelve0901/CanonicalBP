...
for idx, stem in enumerate(stemlist):
    ...
    for i in range(len(reses0)-4):
        ...
        #make unitid
        if (cbpnm0=="A" and cbpnm1=="U") or (cbpnm1=="A" and cbpnm0=="U"): cbpmf = "AU"
        elif (cbpnm0=="G" and cbpnm1=="C") or (cbpnm1=="G" and cbpnm0=="C"): cbpmf = "GC"
        elif (cbpnm0=="G" and cbpnm1=="U") or (cbpnm1=="G" and cbpnm0=="U"): cbpmf = "GU"
        else:
            print("========================================")
