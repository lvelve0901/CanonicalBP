...
name = "Plotseq_rna_free+metal_XP.pdf"
...
UA = abg.loc[seq['3bps'].str[0:2] == 'UA']
UG = abg.loc[seq['3bps'].str[0:2] == 'UG']
...
hist1D(fig1,4,2,7, UA.beta,1,'UA','red',0,60,0.2,legend=None)
hist1D(fig1,4,2,8, UG.beta,1,'UG','red',0,60,0.2,legend=None)
...
hist1D(fig1,4,2,7, UA.gamma,6,'UA','red',-180,180,0.1,legend=None)
hist1D(fig1,4,2,8, UG.gamma,6,'UG','red',-180,180,0.1,legend=None)
...
hist1D(fig1,4,2,7, UA.zeta,1,'UA','red',0,60,0.2,legend=None)
hist1D(fig1,4,2,8, UG.zeta,1,'UG','red',0,60,0.2,legend=None)
...
phist2D(fig1,4,2,7,UA.gamma*np.pi/180,UA.beta,np.pi/20,2,0.04,'UA',0,60,[0,15,30,45,60],'')
phist2D(fig1,4,2,8,UG.gamma*np.pi/180,UG.beta,np.pi/20,2,0.04,'UG',0,60,[0,15,30,45,60],'')
...
phist2D(fig1,4,2,7,UA.gamma*np.pi/180,UA.zeta,np.pi/20,2,0.04,'UA',0,60,[0,15,30,45,60],'')
phist2D(fig1,4,2,8,UG.gamma*np.pi/180,UG.zeta,np.pi/20,2,0.04,'UG',0,60,[0,15,30,45,60],'')
...
hist2D(fig1,4,2,7,UA.beta,UA.zeta,2,2,0.006,'UA',' ',' ',0,60,0,60,colorbar=False)
hist2D(fig1,4,2,8,UG.beta,UG.zeta,2,2,0.006,'UG',' ',' ',0,60,0,60,colorbar=False)
