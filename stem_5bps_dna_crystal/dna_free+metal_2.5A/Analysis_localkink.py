...
fig = pl.figure(2,figsize=(24,7))

hist2D(fig,3,8,1 ,seq.mingw1.convert_objects(convert_numeric=True),abg.beta,0.5,2,0.01,"","minor_gw1","betah",0,20,0,60)
hist2D(fig,3,8,2 ,seq.mingw2.convert_objects(convert_numeric=True),abg.beta,0.5,2,0.01,"","minor_gw2","betah",0,20,0,60)
hist2D(fig,3,8,3 ,seq.roll1.convert_objects(convert_numeric=True),abg.beta,2,2,0.004,"","roll1","betah",-40,40,0,60)
hist2D(fig,3,8,4 ,seq.roll1.convert_objects(convert_numeric=True),abg.beta,2,2,0.004,"","roll2","betah",-40,40,0,60)
hist2D(fig,3,8,5 ,seq.twist1.convert_objects(convert_numeric=True),abg.beta,2,2,0.004,"","twist1","betah",10,70,0,60)
hist2D(fig,3,8,6 ,seq.twist2.convert_objects(convert_numeric=True),abg.beta,2,2,0.004,"","twist2","betah",10,70,0,60)
hist2D(fig,3,8,7 ,seq.slide1.convert_objects(convert_numeric=True),abg.beta,0.1,2,0.04,"","slide1","betah",-2,4,0,60)
hist2D(fig,3,8,8 ,seq.slide2.convert_objects(convert_numeric=True),abg.beta,0.1,2,0.04,"","slide2","betah",-2,4,0,60)

hist2D(fig,3,8,9 ,seq.mingw1.convert_objects(convert_numeric=True),abg.gamma,0.5,10,0.001,"","minor_gw1","gammah",0,20,-180,180)
hist2D(fig,3,8,10 ,seq.mingw2.convert_objects(convert_numeric=True),abg.gamma,0.5,10,0.001,"","minor_gw2","gammah",0,20,-180,180)
hist2D(fig,3,8,11,seq.roll1.convert_objects(convert_numeric=True),abg.gamma,2,10,0.0004,"","roll1","gammah",-40,40,-180,180)
hist2D(fig,3,8,12,seq.roll1.convert_objects(convert_numeric=True),abg.gamma,2,10,0.0004,"","roll2","gammah",-40,40,-180,180)
hist2D(fig,3,8,13,seq.twist1.convert_objects(convert_numeric=True),abg.gamma,2,10,0.0004,"","twist1","gammah",10,70,-180,180)
hist2D(fig,3,8,14,seq.twist2.convert_objects(convert_numeric=True),abg.gamma,2,10,0.0004,"","twist2","gammah",10,70,-180,180)
hist2D(fig,3,8,15,seq.slide1.convert_objects(convert_numeric=True),abg.gamma,0.1,10,0.004,"","slide1","gammah",-2,4,-180,180)
hist2D(fig,3,8,16,seq.slide2.convert_objects(convert_numeric=True),abg.gamma,0.1,10,0.004,"","slide2","gammah",-2,4,-180,180)

hist2D(fig,3,8,17,seq.mingw1.convert_objects(convert_numeric=True),abg.zeta,0.5,2,0.01,"","minor_gw1","zetah",0,20,0,60)
hist2D(fig,3,8,18,seq.mingw2.convert_objects(convert_numeric=True),abg.zeta,0.5,2,0.01,"","minor_gw2","zetah",0,20,0,60)
hist2D(fig,3,8,19,seq.roll1.convert_objects(convert_numeric=True),abg.zeta,2,2,0.004,"","roll1","zetah",-40,40,0,60)
hist2D(fig,3,8,20,seq.roll1.convert_objects(convert_numeric=True),abg.zeta,2,2,0.004,"","roll2","zetah",-40,40,0,60)
hist2D(fig,3,8,21,seq.twist1.convert_objects(convert_numeric=True),abg.zeta,2,2,0.004,"","twist1","zetah",10,70,0,60)
hist2D(fig,3,8,22,seq.twist2.convert_objects(convert_numeric=True),abg.zeta,2,2,0.004,"","twist2","zetah",10,70,0,60)
hist2D(fig,3,8,23,seq.slide1.convert_objects(convert_numeric=True),abg.zeta,0.1,2,0.04,"","slide1","zetah",-2,4,0,60)
hist2D(fig,3,8,24,seq.slide2.convert_objects(convert_numeric=True),abg.zeta,0.1,2,0.04,"","slide2","zetah",-2,4,0,60)
