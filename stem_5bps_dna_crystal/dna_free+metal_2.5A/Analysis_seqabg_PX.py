...
name = "Plotseq_dna_free+metal_PX.pdf"
...
hist1D(fig1,4,2,4, AT.beta,1,'AT','red',0,60,0.2,legend=None)
...
hist1D(fig1,4,2,8, GT.beta,1,'GT','red',0,60,0.2,legend=None)
...
hist1D(fig1,4,2,4, AT.gamma,6,'AT','red',-180,180,0.1,legend=None)
...
hist1D(fig1,4,2,8, GT.gamma,6,'GT','red',-180,180,0.1,legend=None)
...
hist1D(fig1,4,2,4, AT.zeta,1,'AT','red',0,60,0.2,legend=None)
...
hist1D(fig1,4,2,8, GT.zeta,1,'GT','red',0,60,0.2,legend=None)
...
phist2D(fig1,4,2,4,AT.gamma*np.pi/180,AT.beta,np.pi/20,2,0.04,'AT',0,60,[0,15,30,45,60],'')
...
phist2D(fig1,4,2,8,GT.gamma*np.pi/180,GT.beta,np.pi/20,2,0.04,'GT',0,60,[0,15,30,45,60],'')
...
phist2D(fig1,4,2,4,AT.gamma*np.pi/180,AT.zeta,np.pi/20,2,0.04,'AT',0,60,[0,15,30,45,60],'')
...
phist2D(fig1,4,2,8,GT.gamma*np.pi/180,GT.zeta,np.pi/20,2,0.04,'GT',0,60,[0,15,30,45,60],'')
...
hist2D(fig1,4,2,4,AT.beta,AT.zeta,2,2,0.006,'AT',' ',' ',0,60,0,60,colorbar=False)
...
hist2D(fig1,4,2,8,GT.beta,GT.zeta,2,2,0.006,'GT',' ',' ',0,60,0,60,colorbar=False)
