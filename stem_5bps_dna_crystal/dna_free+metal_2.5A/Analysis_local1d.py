...
hist1D(fig,4,8,1 , seq.slide1,0.2,'slide1','red',-2,4,0.2,legend=None)
hist1D(fig,4,8,2 , seq.roll1,2,'roll1','red',-30,30,0.2,legend=None)
hist1D(fig,4,8,3 , seq.twist1,2,'twist1','red',0,60,0.2,legend=None)
hist1D(fig,4,8,4 , seq.incli1,2,'incli1','red',-30,30,0.2,legend=None)
x = seq.mingw1.convert_objects(convert_numeric=True)
hist1D(fig,4,8,5 , x[~np.isnan(x)],0.5,'mingw1','red',5,25,0.2,legend=None)

hist1D(fig,4,8,9 , seq.slide2,0.2,'slide2','red',-2,4,0.2,legend=None)
hist1D(fig,4,8,10 , seq.roll2,2,'roll2','red',-30,30,0.2,legend=None)
hist1D(fig,4,8,11, seq.twist2,2,'twist2','red',0,60,0.2,legend=None)
hist1D(fig,4,8,12, seq.incli2,2,'incli2','red',-30,30,0.2,legend=None)
x = seq.mingw2.convert_objects(convert_numeric=True)
hist1D(fig,4,8,13, x[~np.isnan(x)],0.5,'mingw2','red',5,25,0.2,legend=None)
